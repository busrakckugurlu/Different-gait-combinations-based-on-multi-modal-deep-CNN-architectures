...
def load_testing_data_frame(src_dir, condition):
        ...
        for i in range(len(id)):
            for l in os.listdir(os.path.join(src_dir, id[i])):
                ...
                if(condition == 'nm' and scene == 'scene1'):
                    tmp_path_list=[]
                    for m in os.listdir(os.path.join(src_dir, id[i],l)):
                        tmp_path_list.append(os.path.join(l,m))
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene1_list.append(frame_path)
            ...
            for l in os.listdir(os.path.join(src_dir, id[i])):
                ...
                if(condition == 'bg' and scene == 'scene1'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene1_bg_list.append(frame_path)
                if (condition == 'bg' and scene == 'scene2'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene2_bg_list.append(frame_path)
                if (condition == 'bg' and scene == 'scene3'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene3_bg_list.append(frame_path)
            ...
            for l in os.listdir(os.path.join(src_dir, id[i])):
                ...
                if(condition == 'cl' and scene == 'scene1'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene1_cl_list.append(frame_path)
                if (condition == 'cl' and scene == 'scene2'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene2_cl_list.append(frame_path)
                if (condition == 'cl' and scene == 'scene3'):
                    ...
                    if len(tmp_path_list)>1:
                        index = randint(0, len(tmp_path_list), 1)
                        frame_path = tmp_path_list[int(index)]
                    scene3_cl_list.append(frame_path)
