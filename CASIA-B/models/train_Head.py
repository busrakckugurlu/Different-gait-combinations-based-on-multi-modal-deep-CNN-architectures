...
x_train, y_train = load_training_data("data/Cropped_Head")
...
history=net.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size), steps_per_epoch=len(x_train)/batch_size, epochs=80)
net.save('weights/MobileNet_Head.ckpt') 
...
# save to json:  
hist_json_file = 'weights/.MobileNet_Head.json' 
